...
namespace Mobilyte\Invoices\Controller\Adminhtml\Post;
...
class Sendmail extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
        ...
        \Mobilyte\Invoices\Model\ResourceModel\Count\Collection $collection,
        \Mobilyte\Invoices\Model\CountFactory $countFactory,
    ...
    public function execute()
    {
        ...
        $receiverInfo = [
            'name' => $customerName,
            'email' => 'hari.mobilyte@outlook.com'
        ];
